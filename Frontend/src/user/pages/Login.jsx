  ...
  return (
    <div className="min-h-screen bg-surface flex items-center justify-center">
      <div className="bg-white rounded-2xl p-10 w-[400px] shadow-[0_4px_20px_rgba(0,0,0,0.04),0_1px_3px_rgba(0,0,0,0.02)] text-center">
        <div className="text-2xl font-bold text-primary mb-2">User Login</div>
        ...
        <button className="w-full bg-brand text-white border-none rounded-xl py-2.5 text-sm font-medium cursor-pointer hover:opacity-90">Sign in</button>
