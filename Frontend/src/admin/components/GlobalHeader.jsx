  ...
  return (
    <header className="flex justify-between items-center w-full h-[72px] px-6 border-b border-white/30 glass shrink-0">
      ...
      <div className="flex items-center gap-4 shrink-0">
        ...
        <button aria-label="Profile" className="bg-none border-none cursor-pointer text-lg text-[#4B5563] hover:text-[#1C1C1E] shrink-0">
          <i className="ph ph-user" />
        </button>
        <button onClick={() => { localStorage.clear(); navigate('/login'); }} aria-label="Logout" className="bg-none border-none cursor-pointer text-lg text-[#4B5563] hover:text-[#1C1C1E] shrink-0">
