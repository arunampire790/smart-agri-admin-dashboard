  ...
  return (
    <>
      ...
      <div className="flex gap-3 mb-4 flex-wrap">
        {[
          { icon: 'ph-list-checks', val: '10', label: 'Total Tasks' },
          { icon: 'ph-clock', val: '5', label: 'Pending' },
          { icon: 'ph-check-circle', val: '3', label: 'Completed' },
        ].map((item, i) => (
          <div key={i} className="flex-1 min-w-[140px] flex items-center gap-3 bg-white border border-[rgba(0,0,0,0.05)] rounded-2xl p-4 shadow-[0_1px_3px_rgba(0,0,0,0.02)]">
            <i className={`${item.icon} text-2xl shrink-0`} style={{ color: '#059669' }} />
            <div>
          ...
          <tbody>
            {(activeTab === 'all' || activeTab === 'pending') && (
              <>
                <tr>
                  ...
                  <td className="px-4 py-4 border-b border-[rgba(0,0,0,0.05)]"><span className="pill inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-semibold bg-[#7676801F] text-text-secondary">Irrigation</span></td>
                  <td className="px-4 py-4 border-b border-[rgba(0,0,0,0.05)]"><span className="pill inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-semibold bg-danger-bg text-danger-text">High</span></td>
                ...
                <tr>
                  ...
                  <td className="px-4 py-4 border-b border-[rgba(0,0,0,0.05)]"><span className="pill inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-semibold bg-[#7676801F] text-text-secondary">Fertilizer</span></td>
                  <td className="px-4 py-4 border-b border-[rgba(0,0,0,0.05)]"><span className="pill inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-semibold bg-warning-bg text-warning-text">Medium</span></td>
            ...
            {(activeTab === 'all' || activeTab === 'inprog') && (
              <tr>
                ...
                <td className="px-4 py-4 border-b border-[rgba(0,0,0,0.05)]"><span className="pill inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-semibold bg-[#7676801F] text-text-secondary">Inspection</span></td>
                <td className="px-4 py-4 border-b border-[rgba(0,0,0,0.05)]"><span className="pill inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-semibold bg-brand-light text-brand-dark">Low</span></td>
