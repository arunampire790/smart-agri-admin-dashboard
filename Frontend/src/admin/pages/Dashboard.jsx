...
export default function Dashboard() {
  ...
  const statCards = [
    ...
    { label: 'Total Robots', value: String(robots.length), note: `${robots.filter((r) => r.status === 'Offline').length} offline`, icon: 'ti-robot', bg: '#FCE8E6', color: '#C5221F', route: '/admin/robots' },
    { label: 'Active Robots', value: String(robots.filter((r) => r.status === 'Active').length), note: 'Currently operating', icon: 'ti-activity', bg: '#E6F4EA', color: '#137333', route: '/admin/robots' },
