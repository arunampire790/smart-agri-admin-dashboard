    ...
    <>
      ...
      <div className="flex gap-3 mb-4 flex-wrap">
        ...
        <div className="flex-1 min-w-[240px] glass-card rounded-[20px] p-5 shadow-[0_8px_32px_0_rgba(0,0,0,0.04)]">
          ...
          {[
            { label: 'Active', val: String(active), dot: 'bg-[#10B981]' },
            { label: 'Idle', val: String(idle), dot: 'bg-[#F59E0B]' },
            { label: 'Offline', val: String(offline), dot: 'bg-[#F43F5E]' },
          ].map((item) => (
          ...
          <div className="mt-4">
            <div className="h-1.5 bg-[#F3F4F6] rounded-[6px] overflow-hidden flex">
              ...
              <div className="h-full bg-[#F59E0B]" style={{ width: `${idlePct}%` }} />
              <div className="h-full bg-[#F43F5E]" style={{ width: `${offlinePct}%` }} />
            </div>
